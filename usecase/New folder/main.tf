...
resource "google_compute_instance" "vm" {
    ...
    metadata = {
        ssh-keys = "venki:${file("C:/Users/venka/OneDrive/Documents/terraform/usecase/NEW FOLDER/js.pub")}"
...
#  }
 ...
 provisioner "file" { 
    ...
    connection {
      type        = "ssh"
      user        = "venki"
      private_key = file("C:/Users/venka/OneDrive/Documents/terraform/usecase/NEW FOLDER/js")
      host        = self.network_interface[0].access_config[0].nat_ip
    }
 }
